...
{
    public const AVAILABLE_TAB_NAME = 'available_company';
    public const AVAILABLE_TAB_TITLE = 'Select Company to assign';
    public const AVAILABLE_TAB_TEMPLATE = '@BrandGui/_partials/_tables/available-company-table.twig';

    public const ASSIGNED_TAB_NAME = 'assignment_company';
    public const ASSIGNED_TAB_TITLE = 'Company to be assigned';
    public const ASSIGNED_TAB_TEMPLATE = '@BrandGui/_partials/_tables/assignment-company-table.twig';
